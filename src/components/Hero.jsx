...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className={`
        w-full flex xl:flex-row flex-col justify-center min-h-screen 
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1
          className={`mt-10 font-palanquin text-8xl leading-[114px] max-sm:text-[72px] max-sm:leading-[82px] font-bold`}
        >
          <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">
            The New Arrival
          </span>
          <br />
          <span className={`text-coral-red inline-blcok mt-3`}>Niket</span>{" "}
          Shoes
        </h1>
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 max-md:mb-10  sm:max-w-sm">
          Discover stylish Niket arrivals, quality confort, and innovation for
          your active life
        </p>
