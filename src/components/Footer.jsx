  ...
  return (
    <footer className="max-container">
      ...
      >
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap w-full">
            ...
            <div key={footerLink.id}>
              ...
              <ul>
                {footerLink.links.map((link) => (
                  <li
                    key={link.id}
                    className="text-white-400 mt-3 font-montserrat text-base leading-normal hover:text-coral-red"
                  >
      ...
      >
        <div
          ...
          font-montserrat cursor-pointer hover:text-coral-red`}
        >
          <img
            src={copyrightSign}
            alt="copy right"
